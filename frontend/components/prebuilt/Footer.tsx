                ...
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-white/10">
                    <div>
                        ...
                        <p className="max-w-[410px] mt-6 text-sm leading-relaxed">
                            A unified data platform for analytics, exploration and insights—helping teams discover, transform and visualize data with integrated tools and AI assistance.
                        </p>
                    </div>
